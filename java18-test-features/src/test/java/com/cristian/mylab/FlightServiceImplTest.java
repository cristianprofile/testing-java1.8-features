...
public class FlightServiceImplTest {
    ...
    @Test
    public void flightRemoveIfIsCheaperThanTwoThousandsEuros() {

        LocalDate date = LocalDate.of(2014, 5, 15);
        Collection<Flight> flightCollection = getFlightCollection(date, false);
        // low cost is a flight cost less or equal 2000 euros, let's remove it
        flightService
                .flightRemoveIfIsCheaperThanHundredEuros(flightCollection,2000d);

		Assert.assertTrue(flightCollection.size() == 1);
		Assert.assertTrue(flightCollection.stream().allMatch(flight->flight.getDestination().equalsIgnoreCase("Japan")));
    ...
    @Test
    public void flightRemoveIfIsCheaperThanFiveHundredEuros() {

        LocalDate date = LocalDate.of(2014, 5, 15);
        Collection<Flight> flightCollection = getFlightCollection(date, false);
        // low cost is a flight cost less or equal 500 euros let's remove it
        flightService
                .flightRemoveIfIsCheaperThanHundredEuros(flightCollection,500d);

        Assert.assertTrue(flightCollection.size() == 3);
